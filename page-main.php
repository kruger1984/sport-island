<?php
/*
Template name: Шаблон для главной станицы
*/
get_header();
?>
	<main class="main-content">
		...
		<div class="wrapper about__flex">
			...
			<p class="about__text">
				<?php echo $post_about->post_excerpt; ?></p>
		...
		<div class="wrapper">
			...
			<section class="slider__slide stock">
				...
				<?php the_post_thumbnail( 'full', array( 'class' => 'stock__thumb' ) ); ?>
		...
		$query = new WP_Query(
			array(
				'numberposts' => -1, // -1 все без ограничений
				'post_type'   => 'cards',
				'meta_key'    => 'club_order',
